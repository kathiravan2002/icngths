...
try {
    ...
    $mail->SMTPAuth   = true;
    $mail->Username   = 'info.icngths@gmail.com';
    $mail->Password   = 'yyeh xdsc rhgd zlgz';
    $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;
    $mail->Port       = 587;

    $mail->setFrom('info.icngths@gmail.com', 'Paper Submission System');
    $mail->addAddress('info.icngths@gmail.com', 'Paper Submissions');
    ...
    $mail->isHTML(true);
    $mail->Subject = 'New Paper Submission - ' . htmlspecialchars($_POST['Paper_Title']);
