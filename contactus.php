...
try {
    ...
    $mail->Password   = 'yyeh xdsc rhgd zlgz'; // App Password
    ...
    $replyMail->Username   = 'info.icngths@gmail.com';
    $replyMail->Password   = 'yyeh xdsc rhgd zlgz';
    $replyMail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;
    $replyMail->Port       = 587;

    $replyMail->setFrom('info.icngths@gmail.com', 'ICNGTHS Team');
